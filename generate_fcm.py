...
def main():
    ...
    output_string = ("".join(fcms))
    with io.open("fcm.xml", "w", encoding="utf-8") as f:
        f.write(output_string)

    with open('fcm.xml', 'r', encoding='utf-8') as file:
        print("File contents fcm.xml:")
        print(" ")
        print(file.read())
        print("The file fcm.xml was created successfully.")
